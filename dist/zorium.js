...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router, _, cookie, observe, renderer, server, state, toHTML, z;
	...
	_.extend(z, {
	  ...
	  classKebab: function(classes) {
	    return _.map(_.keys(_.pick(classes, _.identity)), _.kebabCase).join(' ');
	  },
	  routerToMiddleware: function(router) {
	    return function(req, res, next) {
	      var err, ref;
	      try {
	        router.resolve({
	          path: req.url,
	          cookies: cookie.parse(((ref = req.headers) != null ? ref.cookie : void 0) || '')
	        });
	        return state.onNextAllSettlemenmt(function() {
	          var ref1, tree;
	          tree = router.resolve({
	            path: req.url,
	            cookies: cookie.parse(((ref1 = req.headers) != null ? ref1.cookie : void 0) || '')
	          });
	          return res.send('<!DOCTYPE html>' + toHTML(tree));
	        });
	      } catch (_error) {
	        err = _error;
...
/***/ function(module, exports, __webpack_require__) {
	...
	renderChild = function(child, props) {
	  ...
	  if (util.isComponent(child)) {
	    ...
	    if (!child.zorium_isWatchingState && _.isFunction((ref = child.state) != null ? ref.subscribe : void 0)) {
	    ...
	    if (!child.zorium_isWatchingOldState && _.isFunction(child.oldState)) {
	      child.oldState(function() {
	        return z.redraw();
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	observStruct = __webpack_require__(14);

	observArray = __webpack_require__(15);

	observ = __webpack_require__(16);
	...
	getAllProperties = function(obj) {
	  var allProps, currentObject, props;
	  allProps = [];
	  currentObject = obj;
	  while (true) {
	...
	extendMethods = function(obj, source) {
	  return _.each(getAllProperties(source), function(key) {
	    if (_.isFunction(source[key])) {
	      return obj[key] = source[key].bind(source);
	    }
	  });
	};
	...
	Router = (function() {
	  function Router() {
	    ...
	    this.Redirect = function(path) {
	      this.name = 'redirect';
	      this.path = path;
	      this.message = "Redirecting to " + path;
	      return this.stack = (new Error()).stack;
	    };
	    this.Redirect.prototype = new Error();
	  }

	  Router.prototype.add = function(path, cb) {
	    return this.router.addRoute(path, cb);
	  };

	  Router.prototype.resolve = function(arg) {
	    var cookies, path, queryParams, ref, route, url;
	    path = arg.path, cookies = arg.cookies;
	    url = parseUrl(path);
	    queryParams = Qs.parse((ref = url.search) != null ? ref.slice(1) : void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	createElement = __webpack_require__(20);
	    ...
	    if (!this.isRedrawScheduled) {
	      ...
	      return window.requestAnimationFrame((function(_this) {
	        return function() {
	          ...
	          _this.isRedrawScheduled = false;
	          ref = _this.registeredRoots;
	          results = [];
	          for (id in ref) {
	            root = ref[id];
	            results.push(_this.render(root.$root, root.tree));
	          }
	          return results;
	        };
	      })(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Qs, Server, cookie, getCurrentPath, parseUrl, renderer, routes, setPath, util, z,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
	...
	setPath = function(path, mode, isReplacement) {
	  if (mode === 'pathname') {
	    if (isReplacement) {
	      return window.history.replaceState(null, null, path);
	    } else {
	...
	Server = (function() {
	  function Server() {
	    ...
	    this.root = null;
	    this.router = null;
	    this.mode = (typeof window !== "undefined" && window !== null ? (ref = window.history) != null ? ref.pushState : void 0 : void 0) ? 'pathname' : 'hash';
	    this.currentPath = null;
	    if (typeof window !== "undefined" && window !== null) {
	      this.globalRoot = document.createElement('div');
	      this.globalRoot.id = 'zorium-root';
	      document.body.appendChild(this.globalRoot);
	  ...
	  Server.prototype.setRoot = function($$root) {
	    return this.root = $$root;
	  };

	  Server.prototype.setMode = function(mode) {
	  ...
	  Server.prototype.link = function(node) {
	    var go;
	    ...
	    node.properties.onclick = function(e) {
	      ...
	      if (isLocal) {
	        e.preventDefault();
	        return go($el.pathname + $el.search);
	      }
	    };
	    return node;
	  };

	  Server.prototype.go = function(path) {
	    var appRoot, body, cookies, err, head, isReplacement, title, tree, url;
	    if (path == null) {
	      path = getCurrentPath(this.mode);
	    }
	    isReplacement = !Boolean(this.currentPath);
	    url = parseUrl(path);
	    ...
	    try {
	      tree = this.router.resolve({
	        path: path,
	        cookies: cookies
	      });
	    } catch (_error) {
	      err = _error;
	      if (err instanceof this.router.Redirect) {
	        return this.go(err.path);
	      } else {
	        throw err;
	      }
	    }
	    ...
	    if (this.root === document) {
	      if ((tree != null ? tree.tagName : void 0) !== 'HTML') {
	        throw new Error('Invalid HTML base element');
	      }
	      head = tree.children[0];
	      body = tree.children[1];
	      title = head != null ? head.children[0] : void 0;
	      appRoot = body != null ? body.children[0] : void 0;
	      if (!((head != null ? head.tagName : void 0) === 'HEAD' && (title != null ? title.tagName : void 0) === 'TITLE')) {
	        throw new Error('Invalid HEAD base element');
	      }
	      if (!((body != null ? body.tagName : void 0) === 'BODY' && appRoot.properties.id === 'zorium-root')) {
	        throw new Error('Invalid BODY base element');
	      }
	      document.title = title.children[0].text;
	      return renderer.render(this.globalRoot, appRoot);
	    } else {
	      return renderer.render(this.root, tree);
	    }
	  };
	  ...
	  Server.prototype.off = function(name, fn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx, State, _, fireSettlement, pendingSettlement, settlementListeners;

	_ = __webpack_require__(8);

	Rx = __webpack_require__(25);

	settlementListeners = [];

	pendingSettlement = 0;

	fireSettlement = function() {
	  _.map(settlementListeners, function(fn) {
	    return fn();
	  });
	  return settlementListeners = [];
	};
	...
	State = function(initialState) {
	  ...
	  _.map(initialState, function(val, key) {
	...
	State.onNextAllSettlemenmt = function(fn) {
	  if (pendingSettlement === 0) {
	    fn();
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isThunk = __webpack_require__(32);
	var softHook = __webpack_require__(33);
	var attrHook = __webpack_require__(34);
	var paramCase = __webpack_require__(35);
	var createAttribute = __webpack_require__(12);
	var voidElements = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _, getTagAttributes, isChild, isChildren, isComponent, isVNode, isVText, isWidget, parseZfuncArgs,
	  slice = [].slice;
	...
	isWidget = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(27);
	var propConfig = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Observ = __webpack_require__(16)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var splice = __webpack_require__(37)
	var put = __webpack_require__(38)
	var set = __webpack_require__(39)
	var transaction = __webpack_require__(40)
	var ArrayMethods = __webpack_require__(41)
	var addListener = __webpack_require__(42)
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(28)(module), (function() { return this; }()), __webpack_require__(52)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addListener = __webpack_require__(42)
	var setNonEnumerable = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var applyPatch = __webpack_require__(54)
	var setNonEnumerable = __webpack_require__(53)
	var adiff = __webpack_require__(71)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ObservArray = __webpack_require__(15)
	...
	function ArrayMethods(obs) {
	    ...
	    obs.reverse = __webpack_require__(55)
	    obs.sort = __webpack_require__(56)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VNode = __webpack_require__(58);
	var VText = __webpack_require__(59);
	...
	var isVThunk = __webpack_require__(51);

	var parseTag = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isVText = __webpack_require__(22)
	var isWidget = __webpack_require__(26)
	var isThunk = __webpack_require__(51)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(74)
	var isArray = __webpack_require__(73)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = __webpack_require__(46)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CAMEL_CASE_REGEXP = __webpack_require__(81)
	var TRAILING_DIGIT_REGEXP = __webpack_require__(82)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minDoc = __webpack_require__(77);
